...
- `data`: data files will be placed here, as needed. They should be named to match the main `.java` file of the assignment, for clarity.
...
![Process standard 1a rubric](docs/media/process_1.png)
...
![Process standard 3b rubric](docs/media/process_3.png)
...
![Product standard 3](docs/media/product_3.png)
